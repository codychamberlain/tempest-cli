...
var stationCmd = &cobra.Command{
	Use:   "station",
	Short: "List stations or show details for one station",
	Long: `List all stations available to the API token, or show details for a
single station when -s <station_id> is given. Details include location,
timezone, and the devices attached to the station.`,
